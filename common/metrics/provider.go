...
// Provider is an abstraction for a metrics provider. It is a factory for
...
// Gauge is a meter that expresses the current value of some metric.
...
// Histogram is a meter that records an observed value into quantized
// buckets.
